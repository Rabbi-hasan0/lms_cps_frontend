...
const handleSaveQuiz = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (!editingQuiz && course) {
      // 🚀 Strapi 5 (Document ID ভিত্তিক) এবং Strapi 4 উভয়ের জন্যই কোর্স রিলেশন কানেক্ট করা
      const courseRelationId = course.documentId || course.id;
      
      payload.course = courseRelationId;
